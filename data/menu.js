...
export const eventTypes = {
  ...
  barat: {
    ...
    emoji: '❤️',
    color: 'maroon',
    gradient: 'from-maroon-800 via-maroon-600 to-maroon-500',
    bgClass: 'event-barat',
    textColor: 'text-maroon-800',
    borderColor: 'border-maroon-400',
    bgColor: 'bg-maroon-50',
    badgeBg: 'bg-maroon-700',
  ...
  nikkah: {
    ...
    emoji: '🤍',
    color: 'gold',
    gradient: 'from-gold-600 via-gold-400 to-gold-500',
  ...
  engagement: {
    ...
    emoji: '💗',
    color: 'rani',
    gradient: 'from-rani-700 via-rani-500 to-rani-400',
    bgClass: 'event-engagement',
    textColor: 'text-rani-700',
    borderColor: 'border-rani-400',
    bgColor: 'bg-rani-50',
    badgeBg: 'bg-rani-600',
